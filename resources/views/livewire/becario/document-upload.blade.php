        ...
        @forelse ($assignments as $assignment)
            ...
            <div class="bg-white border border-zinc-200 rounded-xl overflow-hidden">
                ...
                <div class="px-5 py-4 flex items-start justify-between gap-4 flex-wrap">
                    ...
                    <div class="shrink-0">
                        @if ($submission && $submission->status !== 'rechazado')
                ...
                <tbody class="divide-y divide-zinc-100">
                    ...
                    <tr class="hover:bg-zinc-50 transition">
                        ...
                        <td class="px-4 py-3 hidden md:table-cell text-xs">
                            <a href="{{ $sub->download_url }}" target="_blank" class="inline-flex items-center gap-1 text-primary-600 hover:underline font-medium">
                                <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
                                </svg>
                                {{ $sub->file_name }}
                            </a>
                            <p class="text-zinc-400 mt-0.5">{{ $sub->file_size_formatted }}</p>
                        </td>
