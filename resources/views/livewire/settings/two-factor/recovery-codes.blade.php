            ...
            <div class="mt-3 space-y-3">
                ...
                @if (filled($recoveryCodes))
                    ...
                    <flux:text variant="subtle" class="text-xs">
                        {{ __('Cada código de recuperación se puede usar una vez para acceder a tu cuenta y se eliminará después de usarse. Si necesitas más, haz clic en Regenerar códigos arriba.') }}
                    </flux:text>
                @endif
            </div>
        </div>
