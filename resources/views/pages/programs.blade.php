            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="mt-4 text-zinc-600 leading-relaxed">
                        Nuestro programa de becas universitarias apoya a jóvenes y mujeres  con necesidad económica, brindándoles educación, acompañamiento integral y herramientas para que lideren cambios sociales, políticos y ecológicos en sus comunidades.
                    </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl p-6 border border-zinc-100 text-center">
                    ...
                    <p class="text-sm text-zinc-500">Apoyamos a jóvenes de pueblos indígenas para que, a través de la educación, fortalezcan su identidad, alcancen sus metas y generen cambios en sus comunidades.</p>
                </div>
            </div>
        </div>
    </section>
