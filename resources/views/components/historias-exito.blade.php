...
$todasLasHistorias = [
    ...
    ['nombre' => 'Carlos',   'depto' => 'Copán',         'carrera' => 'Lic. en Desarrollo Social',  'avatar' => 'CA', 'imagen' => 'Carlos.webp',                   'tag' => 'Inclusión',             'historia' => 'Nació con una condición que le impide caminar, pero eso no detuvo su impulso. Promueve la inclusión y los derechos de las personas con discapacidad desde la educación digital.'],
    ['nombre' => 'Xiomara',  'depto' => 'Santa Bárbara', 'carrera' => 'Técnico en Administración',  'avatar' => 'XI', 'imagen' => 'Xiomara.webp',                   'tag' => 'Primera generación',   'historia' => 'Primera mujer de su familia en acceder a la universidad, abriendo un camino que sus hermanas menores ahora también sueñan con recorrer.'],
    ['nombre' => 'Mariela',  'depto' => 'Copán',         'carrera' => 'Técnico en Laboratorio',     'avatar' => 'MA', 'imagen' => 'Mariela.webp',                   'tag' => 'Perseverancia',         'historia' => 'Superó barreras económicas para ejercer su derecho a formarse. Su esfuerzo diario es la prueba de que cuando hay voluntad, siempre hay un camino hacia adelante.'],
];
