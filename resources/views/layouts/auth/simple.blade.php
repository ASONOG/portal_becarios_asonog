...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-white antialiased">
        ...
        <div class="min-h-screen flex">
            ...
            <div class="hidden lg:flex lg:w-1/2 xl:w-2/5 flex-col justify-between bg-gradient-to-br from-blue-900 to-blue-700 text-white p-12 relative overflow-hidden">
                ...
                <div class="relative z-10 space-y-8">
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <span class="text-sm text-blue-100">{{ $f['text'] }}</span>
                        </li>
                        @endforeach
                    </ul>
                </div>
                ...
                {{-- Footer del panel --}}
                <p class="text-blue-300 text-xs relative z-10">
            ...
            <div class="flex flex-1 flex-col justify-center items-center px-6 py-12 sm:px-12">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-2 mb-10 lg:hidden">
                    <span class="flex items-center justify-center w-9 h-9 rounded-lg bg-blue-700 text-white font-bold">A</span>
